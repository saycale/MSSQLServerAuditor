...
<root>
	<mssqlauditorpreprocessors name="Панель управления" id="InstanceDashboard.Graph.ru" columns="33;33;34" rows="33;33;34" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="InstanceDashboard.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Instance Processes (Day)" id="InstanceSummaryProcessesDay.Graph.ru" column="2" row="3" colspan="1" rowspan="1">
			<GraphConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
				<FirstWeekDay>
					Monday
				</FirstWeekDay>
