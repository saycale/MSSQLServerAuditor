...
<root>
	<mssqlauditorpreprocessors name="Database restoration: date and size (MBytes) of the last restoration" id="DatabasesRestore.HTML.ru" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database restoration: date and size (MBytes) of the last restoration" id="DatabasesRestore.HTML.ru">
