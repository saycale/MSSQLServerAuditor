...
<root>
	<mssqlauditorpreprocessors name="Jobs Execution History" id="JobsExecutionHistory.HTML.ru" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Jobs Execution History" id="JobsExecutionHistory.HTML.ru">
