...
<root>
	<mssqlauditorpreprocessors name="Data about MS SQL server" id="AuditInstanceParameters.HTML.ru" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Data about MS SQL server" id="AuditInstanceParameters.HTML.ru">
