...
<root>
	<mssqlauditorpreprocessors name="Именованные линии" id="NamedLineGraph.HTML.ru" columns="100" rows="50;50" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="NamedLineGraph.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="jNamedLineGraph.Graph.ru" column="1" row="2" colspan="1" rowspan="1">
