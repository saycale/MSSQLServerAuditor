...
<root>
<!--	<mssqlauditorpreprocessors name="Список хранимых процедур" id="DatabaseObjects.HTML.ru" columns="100" rows="100" splitter="yes">-->
<!--		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Список хранимых процедур" id="DatabaseObjects.HTML.ru">-->
...
<!--	</mssqlauditorpreprocessors>-->
    <mssqlauditorpreprocessors name="Проблемы T-SQL кода" id="DatabaseErrors.HTML.ru" columns="50;50" rows="100" splitter="yes">
       <mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Проблемы T-SQL кода" id="DatabaseErrors1.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
					xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
					xmlns:ms="urn:schemas-microsoft-com:xslt"
					xmlns:dt="urn:schemas-microsoft-com:datatypes">
       ...
       <mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Проблемы T-SQL кода" id="DatabaseErrors2.HTML.ru" column="2" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
                            xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                            xmlns:ms="urn:schemas-microsoft-com:xslt"
                            xmlns:dt="urn:schemas-microsoft-com:datatypes">
