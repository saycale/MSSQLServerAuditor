...
<root>
	<mssqlauditorpreprocessors name="Проблемы T-SQL кода" id="DatabaseObjectsSQLCodeGuard.HTML.ru" columns="50;50" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Проблемы T-SQL кода" id="DatabaseObjectsSQLCodeGuard.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Список ошибок" id="DatabaseErrors.HTML.ru" column="2" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				xmlns:ms="urn:schemas-microsoft-com:xslt"
				xmlns:dt="urn:schemas-microsoft-com:datatypes">
