...
<root>
	<mssqlauditorpreprocessors name="Осиротевшие пользователи" id="OrphanUseres.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="OrphanUseres.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Осиротевшие пользователи (описание)" id="OrphanUseres.Description.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="OrphanUseres.Description.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
					xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
					xmlns:ms="urn:schemas-microsoft-com:xslt"
					xmlns:dt="urn:schemas-microsoft-com:datatypes">
