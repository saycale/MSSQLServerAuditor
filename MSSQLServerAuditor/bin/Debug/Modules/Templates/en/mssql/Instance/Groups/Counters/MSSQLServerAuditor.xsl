...
<root>
	<mssqlauditorpreprocessors name="Список счетчиков оперативной памяти" id="InstanceMemoryStatus.HTML.en" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Список счетчиков оперативной памяти" id="InstanceMemoryStatus.HTML.en">
