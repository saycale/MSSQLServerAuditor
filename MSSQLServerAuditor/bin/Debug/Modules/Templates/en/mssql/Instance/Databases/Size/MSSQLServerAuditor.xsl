...
<root>
	<mssqlauditorpreprocessors name="Столбчатая диаграмма" id="DatabasesSize.ColumnDiagramm.en" columns="100" rows="80;15;5" splitter="yes">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Файлы для базы данных (МБайт)" id="DatabaseFilesSize.HTML.en" column="1" row="2" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="DatabaseFilesSize.HTML.Results.en" column="1" row="3" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
	...
	<mssqlauditorpreprocessors name="Круговая диаграмма" id="DatabasesSize.PieDiagramm.en" columns="100" rows="80;15;5" splitter="yes">
