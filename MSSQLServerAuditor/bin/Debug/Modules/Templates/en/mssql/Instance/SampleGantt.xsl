...
<root>
	<mssqlauditorpreprocessors name="История выполнения плановых заданий (график)" id="JobsExecutionHistory.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="История выполнения плановых заданий (график)" id="JobsExecutionHistory.Graph.en" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="Ticket188TestSql.HTML.Results.en" column="1" row="2" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Диаграмма Ганта выполнения плановых заданий (график)" id="JobsExecutionHistoryGantt.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Диаграмма Ганта выполнения плановых заданий (график)" id="JobsExecutionHistoryGantt.Graph.en" column="1" row="1" colspan="1" rowspan="1">
			<GraphConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="JobsExecutionHistoryGantt.HTML.Results.en" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
	...
	<mssqlauditorpreprocessors name="История выполнения плановых заданий (график)" id="JobsExecutionHistoryGantt.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessor" name="Диаграмма Ганта выполнения плановых заданий (inline)" id="JobsExecutionHistoryGantt.Graph.en" column="1" row="1" colspan="1" rowspan="1">
			<GraphConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
				<!--This tag is new added. It applies to "Interval" property of .net Charting.Axis object. Zero means the value will be adjusted automaticaly.
					If this tag is omited the property value will be assigned to 1.0 (as was implemented in SQLAuditor charting subsystem) -->
				<Interval>0.0</Interval>
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="JobsExecutionHistoryGantt.HTML.Result.en" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
