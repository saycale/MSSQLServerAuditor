...
<root>
	<mssqlauditorpreprocessors name="DynamicManagementView" id="DynamicManagementView.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="DynamicManagementView" id="DynamicManagementView.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<xsl:if test="MSSQLResult[@SqlErrorNumber='0' and @hierarchy='']/RecordSet[@id='1']/Row/child::node()">
				<table id="myTable">
				<thead>
					<tr>
						<th>
						...
						<xsl:for-each select="MSSQLResult[@SqlErrorNumber='0' and @hierarchy='']/RecordSet[@id='1']/Row[@id='1']/*">
						<th>
							<xsl:value-of select="name()"/>
						</th>
						</xsl:for-each>
				...
				<tbody>
					<xsl:for-each select="MSSQLResult[@SqlErrorNumber='0' and @hierarchy='']/RecordSet[@id='1']/Row">
					<tr>
						<td>
							<xsl:choose>
								<xsl:when test="../../@instance != ''">
