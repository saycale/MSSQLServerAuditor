...
<root>
	<mssqlauditorpreprocessors name="Тикет 21 (диаграмма)" id="Ticket21Diagram.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="ticket 21 diagram" id="Ticket21Diagram.Graph.en" column="1" row="1" colspan="1" rowspan="1">
			<GraphConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
				...
				<GraphSource xsi:type="XmlFileGraphSource">
					...
					<PathToItems>MSSQLResults/MSSQLResult[@name='Ticket21TestSql' and @hierarchy='']/RecordSet[@id='1']</PathToItems>
					<ItemTag>Row</ItemTag>
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="Ticket21Diagram.Graph.Results.en" column="1" row="2" colspan="1" rowspan="1">
