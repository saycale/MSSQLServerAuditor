...
<root>
	<mssqlauditorpreprocessors name="Описание объекта баз данных (информация)" id="TableInfo.HTML.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Описание объекта баз данных (информация)" id="TableInfo.HTML.en" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="TableInfo.HTML.Results.en" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
