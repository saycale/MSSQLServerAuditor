...
<root>
	<mssqlauditorpreprocessors name="История архивного копирование (таблицы)" id="DatabaseBackupHistory.HTML.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="История архивного копирование (таблицы)" id="DatabaseBackupHistory.HTML.en" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="DatabaseBackupHistory.HTML.Results.en" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
	...
	<mssqlauditorpreprocessors name="История архивного копирование (графики)" id="DatabaseBackupHistory.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="История архивного копирование (графики)" id="DatabaseBackupHistory.Graph.en" column="1" row="1" colspan="1" rowspan="1">
			<GraphConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
				...
				<GraphSource xsi:type="XmlFileGraphSource">
					...
					<ItemTag>GetDatabaseBackupHistory</ItemTag>
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="DatabaseBackupHistory.Graph.Results.en" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
