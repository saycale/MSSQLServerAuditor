...
<root>
	<mssqlauditorpreprocessors name="Работающие процессы (диаграмма)" id="RunningProcesses.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Работающие процессы (диаграмма)" id="RunningProcesses.Graph.en" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="RunningProcesses.HTML.Results.en" column="1" row="2" colspan="1" rowspan="1">
