...
<root>
	<mssqlauditorpreprocessors name="Тестирование #98" id="TestDataForTicket98.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="TestDataForTicket98.Graph.en" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="TestDataForTicket98.Graph.Results.en" column="1" row="2" colspan="1" rowspan="1">
