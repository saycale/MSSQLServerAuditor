...
<root>
	<mssqlauditorpreprocessors name="Архивные копии баз данных (размер МБайт)" id="Group.DatabasesBackup.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="Group.DatabasesBackup.HTML.en" column="1" row="1" colspan="1" rowspan="1">
