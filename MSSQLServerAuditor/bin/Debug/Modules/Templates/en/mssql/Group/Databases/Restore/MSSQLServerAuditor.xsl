...
<root>
	<mssqlauditorpreprocessors name="Восстановленные базы данных: дата и размер (МБайт) последнего восстановления" id="DatabasesRestore.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="DatabasesRestore.HTML.en" column="1" row="1" colspan="1" rowspan="1">
