...
<root>
	...
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Orphan users" id="OrphanUseres.HTML.en">
	...
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Orphan users (description)" id="OrphanUseres.Description.HTML.en">
		<xsl:stylesheet version="1.0"
			  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
			  xmlns:ms="urn:schemas-microsoft-com:xslt"
			  xmlns:dt="urn:schemas-microsoft-com:datatypes">
