...
<root>
	<mssqlauditorpreprocessors name="Database distribution by size (Mb)" id="DatabasesSize.HTML.en" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database distribution by size (Mb)" id="DatabasesSize.HTML.en">
