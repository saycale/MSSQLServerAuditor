...
<root>
	<mssqlauditorpreprocessors name="LDAP Disabled Person Users" id="LDAPDisabledPersonUsers.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="LDAP Person Users" id="LDAPDisabledPersonUsers.HTML.en" column="1" row="1" colspan="1" rowspan="1">
