...
<root>
	<mssqlauditorpreprocessors name="LDAP Person Users By Group" id="LDAPPersonUsersByGroup.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="LDAP Person Users By Group" id="LDAPPersonUsersByGroup.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
