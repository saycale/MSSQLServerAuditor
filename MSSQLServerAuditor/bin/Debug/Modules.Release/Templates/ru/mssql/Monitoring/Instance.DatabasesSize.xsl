...
<root>
	<mssqlauditorpreprocessors name="Распределение баз данных по размеру (МБайт)" id="Monitoring.Instance.DatabasesSize.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Распределение баз данных по размеру (МБайт)" id="Monitoring.Instance.DatabasesSize.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
