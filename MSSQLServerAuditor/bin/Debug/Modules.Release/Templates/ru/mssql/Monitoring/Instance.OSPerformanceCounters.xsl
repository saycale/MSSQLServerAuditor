...
<root>
	<mssqlauditorpreprocessors name="Счётчики производительности" id="InstanceOSPerformanceCounters.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Счётчики производительности" id="InstanceOSPerformanceCounters.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
