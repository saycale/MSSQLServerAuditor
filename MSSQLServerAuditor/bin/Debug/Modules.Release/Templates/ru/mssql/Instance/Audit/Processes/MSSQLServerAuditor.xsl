...
<root>
	<mssqlauditorpreprocessors name="Запущенные процессы (пользовательские)" id="ServerUserProcesses.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Запущенные процессы (пользовательские)" id="ServerUserProcesses.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<xsl:if test="MSSQLResult[@name='GetInstanceProcesses' and @SqlErrorNumber='0' and @hierarchy='Users']/RecordSet[@id='1']/child::node()">
				<table id="myTable">
				<thead>
					<tr>
						<th>
				...
				<tbody>
					<xsl:for-each select="MSSQLResult[@name='GetInstanceProcesses' and @SqlErrorNumber='0' and @hierarchy='Users']/RecordSet[@id='1']/Row">
					<tr>
	...
	<mssqlauditorpreprocessors name="Запущенные процессы (все)" id="ServerAllProcesses.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Запущенные процессы (все)" id="ServerAllProcesses.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
			...
			<body>
				...
				<xsl:if test="MSSQLResult[@name='GetInstanceProcesses' and @SqlErrorNumber='0' and @hierarchy='All']/RecordSet[@id='1']/child::node()">
				<table id="myTable">
				<thead>
					<tr>
						<th>
				...
				<tbody>
					<xsl:for-each select="MSSQLResult[@name='GetInstanceProcesses' and @SqlErrorNumber='0' and @hierarchy='All']/RecordSet[@id='1']/Row">
					<tr>
						<xsl:if test="BlockedID != 0">
							<xsl:attribute name="bgcolor">#FA8072</xsl:attribute>
						</xsl:if>
