...
<root>
	<mssqlauditorpreprocessors name="История архивного копирование (таблицы)" id="DatabaseBackupHistory.HTML.ru" columns="100" rows="100" splitter="yes">
	...
	<mssqlauditorpreprocessors name="История архивного копирования (графики)" id="DatabaseBackupHistory.Graph.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="История архивного копирование (графики)" id="DatabaseBackupHistory.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
