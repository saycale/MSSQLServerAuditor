...
<root>
	<mssqlauditorpreprocessors name="Хранимые процедуры с sp_" id="DatabaseProceduresWithSPName.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Хранимые процедуры с sp_" id="DatabaseProceduresWithSPName.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
