...
<root>
	<mssqlauditorpreprocessors name="Карта памяти сервера" id="InstanceMemoryMap.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Карта памяти сервера" id="InstanceMemoryMap.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
