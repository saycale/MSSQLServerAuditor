...
<root>
	<mssqlauditorpreprocessors name="Базы данных экземпляра (статистические данные)" id="DatabasesCount.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Базы данных экземпляра (статистические данные)" id="DatabasesCount.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
