...
<root>
	<mssqlauditorpreprocessors name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.HTML.ru" columns="100" rows="20;80;20" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.1x1.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.1x2.HTML.ru" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.1x3.HTML.ru" column="1" row="3" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
	...
	<mssqlauditorpreprocessors name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.Table.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="DataGridPreprocessorDialog" name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.Table.ru" column="1" row="1" colspan="1" rowspan="1">
			<TableConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" UseAutoSize="true">
				<TableSource xsi:type="XmlFileTableSource">
					...
					<ItemTag>Row</ItemTag>
					<Columns>
						<XmlFileTableSourceItem Tag="nt_username"  ColumnName="Пользователь"  HeaderAlign="Center" Type="NText"                                         />
						<XmlFileTableSourceItem Tag="spid"         ColumnName="#"             HeaderAlign="Center" Type="Int"           Align="Right" Format="###,###"  />
						<XmlFileTableSourceItem Tag="blocked"      ColumnName="Блокирован"    HeaderAlign="Center" Type="Int"           Align="Right" Format="###,###"  />
						...
						<XmlFileTableSourceItem Tag="Snapshots"    ColumnName="Число"         HeaderAlign="Center" Type="NText"                                         />
						<XmlFileTableSourceItem Tag="cmd_history"  ColumnName="Команды"       HeaderAlign="Center" Type="NText"                                         />
						<XmlFileTableSourceItem Tag="last_batch"   ColumnName="Время команды" HeaderAlign="Center" Type="SmallDateTime"                                 />
						<XmlFileTableSourceItem Tag="program_name" ColumnName="Программа"     HeaderAlign="Center" Type="NText"                                         />
						<XmlFileTableSourceItem Tag="hostname"     ColumnName="Компьютер"     HeaderAlign="Center" Type="NText"                                         />
					</Columns>
				</TableSource>
			</TableConfiguration>
		</mssqlauditorpreprocessor>
