...
<root>
	<mssqlauditorpreprocessors name="Данные о регулярных заданиях" id="Jobs.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Данные о регулярных заданиях" id="Jobs.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Описание" id="ServerJobs.Description.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Описание" id="ServerJobs.Description.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
					xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
					xmlns:ms="urn:schemas-microsoft-com:xslt"
					xmlns:dt="urn:schemas-microsoft-com:datatypes">
			...
			<body>
				...
				<h1 class="firstHeading">Владелец задания - пользователь, а не
				администратор</h1>
				...
				<p><strong>Как это исправить:</strong> If the jobs have been failing because
				...
				<p><strong>Уровень опасности:</strong> Невысокий</p>
