...
<root>
	<mssqlauditorpreprocessors name="Использование процессора" id="InstanceCPUUtilization.Graph.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Использование процессора" id="InstanceCPUUtilization.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
