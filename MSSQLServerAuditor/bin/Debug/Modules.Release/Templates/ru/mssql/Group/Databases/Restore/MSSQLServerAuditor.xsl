...
<root>
	<mssqlauditorpreprocessors name="Восстановленные базы данных: дата и размер (МБайт) последнего восстановления" id="DatabasesRestore.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Восстановленные базы данных: дата и размер (МБайт) последнего восстановления" id="DatabasesRestore.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
