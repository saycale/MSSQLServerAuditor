...
<root>
	<mssqlauditorpreprocessors name="Данные о сетевом статусе сервера" id="NetworkInformation.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="NetworkInformation.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<tbody>
					...
					<tr>
						<xsl:if test="NetworkStatus != 'Success'">
