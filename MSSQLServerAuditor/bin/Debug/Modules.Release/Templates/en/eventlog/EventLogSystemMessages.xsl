...
<root>
	<mssqlauditorpreprocessors name="EventLog System Messages" id="EventLogSystemMessages.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="EventLog System Messages" id="EventLogSystemMessages.HTML.en" column="1" row="1" colspan="1" rowspan="1">
