...
<root>
	<mssqlauditorpreprocessors name="Summary Databases Size (MB)" id="InstanceDatabasesSizeSummary.Graph.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Summary Databases Size (MB)" id="InstanceDatabasesSizeSummary.Graph.en" column="1" row="1" colspan="1" rowspan="1">
