...
<root>
	<mssqlauditorpreprocessors name="Instance DBCC SQL Perf" id="InstanceDBCCMemoryStatus.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Instance DBCC Memory Status" id="InstanceDBCCSQLPerf.HTML.en" column="1" row="1" colspan="1" rowspan="1">
