...
<root>
	<mssqlauditorpreprocessors name="SQLite Tables" id="SQLiteTables.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="SQLite Tables" id="SQLiteTables.HTML.en" column="1" row="1" colspan="1" rowspan="1">
