...
<root>
	<mssqlauditorpreprocessors name="User Alises" id="DatabaseUserAliases.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="User Alises" id="DatabaseUserAliases.HTML.en" column="1" row="1" colspan="1" rowspan="1">
