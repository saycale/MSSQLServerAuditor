...
<root>
	<mssqlauditorpreprocessors name="Indexes Fill Factor Summary" id="IndexesFillFactorSummary.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Indexes Fill Factor Summary" id="IndexesFillFactorSummary.HTML.en" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Indexes Fill Factor (detailed)" id="IndexesFillFactor.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Indexes Fill Factor (detailed)" id="IndexesFillFactor.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
