...
<root>
	<mssqlauditorpreprocessors name="Jobs execution history (table)" id="JobsExecutionHistory.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Jobs execution history (table)" id="JobsExecutionHistory.HTML.en" column="1" row="1" colspan="1" rowspan="1">
