...
<root>
	...
	<mssqlauditorpreprocessors name="Databases Size (MB)" id="DatabasesSize.Table.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="DataGridPreprocessorDialog" name="DatabasesSize (MB)" id="DatabasesSize.Table.en" column="1" row="1" colspan="1" rowspan="1">
			<TableConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" UseAutoSize="true">
				<TableSource xsi:type="XmlFileTableSource">
					...
					<Columns>
						...
						<XmlFileTableSourceItem Tag="DatabaseSizeMB"         ColumnName="Size"        HeaderAlign="Center" Type="Float" Align="Right" Format="###,###.0"/>
	...
	<mssqlauditorpreprocessors name="Databases Size: Bar" id="DatabasesSize.ColumnDiagramm.en" columns="100" rows="100" splitter="yes">
	...
	<mssqlauditorpreprocessors name="DatabasesSize: Pie" id="DatabasesSize.PieDiagramm.en" columns="100" rows="100" splitter="yes">
