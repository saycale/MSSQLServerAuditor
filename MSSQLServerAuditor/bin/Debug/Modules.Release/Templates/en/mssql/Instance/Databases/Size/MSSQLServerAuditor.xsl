...
<root>
	<mssqlauditorpreprocessors name="Bar" id="DatabasesSize.ColumnDiagramm.en" columns="100" rows="80;20" splitter="yes">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database Files (MB)" id="DatabaseFilesSize.HTML.en" column="1" row="2" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Pie" id="DatabasesSize.PieDiagramm.en" columns="100" rows="80;20" splitter="yes">
