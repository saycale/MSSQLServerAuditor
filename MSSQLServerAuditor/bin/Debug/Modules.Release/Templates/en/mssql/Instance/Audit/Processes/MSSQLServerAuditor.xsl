...
<root>
	<mssqlauditorpreprocessors name="Running user processes" id="ServerUserProcesses.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Running user processes" id="ServerUserProcesses.HTML.en" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="All Running Processes" id="ServerAllProcesses.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="All Running Processes" id="ServerAllProcesses.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
