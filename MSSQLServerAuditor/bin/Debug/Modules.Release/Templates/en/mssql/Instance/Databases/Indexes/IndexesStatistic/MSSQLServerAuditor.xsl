...
<root>
	<mssqlauditorpreprocessors name="Index statistics" id="IndexesStatisticStatus.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Index statistics" id="IndexesStatisticStatus.HTML.en" column="1" row="1" colspan="1" rowspan="1">
