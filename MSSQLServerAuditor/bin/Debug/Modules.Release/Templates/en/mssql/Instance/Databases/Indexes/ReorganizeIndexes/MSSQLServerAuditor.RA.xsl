...
<root>
	<mssqlauditorpreprocessors name="Indexes for Reorganize" id="ReorganizeIndexes.Description.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Indexes for Reorganize" id="ReorganizeIndexes.Description.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<h1 class="firstHeading">Indexes for "Reorganize"</h1>

				<p>Report provide the list of indexes, which are required to perform operation "Reorganize".</p>
