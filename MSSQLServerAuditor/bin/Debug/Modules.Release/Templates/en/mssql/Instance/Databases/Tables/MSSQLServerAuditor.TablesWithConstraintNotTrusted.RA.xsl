...
<root>
	<mssqlauditorpreprocessors name="Constraints Not Trusted" id="TablesWithConstraintsNotTrusted.Description.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Constraints Not Trusted" id="TablesWithConstraintsNotTrusted.Description.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<p>This report checks sys.check_constraints looking for constraints with
				is_not_trusted = 1.</p>
