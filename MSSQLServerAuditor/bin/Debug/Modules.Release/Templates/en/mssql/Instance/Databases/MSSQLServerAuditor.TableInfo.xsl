...
<root>
	<mssqlauditorpreprocessors name="Database object (info)" id="TableInfo.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database object (info)" id="TableInfo.HTML.en" column="1" row="1" colspan="1" rowspan="1">
