...
<root>
	<mssqlauditorpreprocessors name="Unnamed table constraints" id="UnnamedConstraints.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Unnamed table constraints" id="UnnamedConstraints.HTML.en" column="1" row="1" colspan="1" rowspan="1">
