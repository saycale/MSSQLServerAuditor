...
<root>
	<mssqlauditorpreprocessors name="List of stored procedures with dynamic SQL" id="DatabaseProceduresWithDynamicSQL.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="List of stored procedures with dynamic SQL" id="DatabaseProceduresWithDynamicSQL.HTML.en" column="1" row="1" colspan="1" rowspan="1">
