...
<root>
<!--	<mssqlauditorpreprocessors name="Stored Procedures" id="DatabaseObjects.HTML.en" columns="100" rows="100" splitter="yes">-->
<!--		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Stored Procedures" id="DatabaseObjects.HTML.en">-->
...
<!--									<tr>-->
<!--										<td bgcolor="#9acd32">Instance</td>-->
<!--										<td bgcolor="#ccdd88">-->
<!--                                            <xsl:value-of select="Instance"/>-->
<!--										</td>-->
<!--										<td bgcolor="#9acd32">Object</td>-->
<!--										<td bgcolor="#ccdd88">-->
...
<!--	</mssqlauditorpreprocessors>-->
    <mssqlauditorpreprocessors name="T-SQL Code issues" id="DatabaseErrors.HTML.en" columns="50;50" rows="100" splitter="yes">
       <mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="T-SQL Code issues" id="DatabaseErrors1.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
					xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
					xmlns:ms="urn:schemas-microsoft-com:xslt"
					xmlns:dt="urn:schemas-microsoft-com:datatypes">
       ...
       <mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="T-SQL Code issues" id="DatabaseErrors2.HTML.en" column="2" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
                            xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                            xmlns:ms="urn:schemas-microsoft-com:xslt"
                            xmlns:dt="urn:schemas-microsoft-com:datatypes">
