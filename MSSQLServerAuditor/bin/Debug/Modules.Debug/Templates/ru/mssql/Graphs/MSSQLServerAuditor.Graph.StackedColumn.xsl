...
<root>
	<mssqlauditorpreprocessors name="Колонки" id="StackedColumn.Graph.ru" columns="100" rows="50;50" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="StackedColumn.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="jStackedColumn.Graph.ru" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<xsl:template match="/MSSQLResults/MSSQLResult[@name='GetStackedColumnGraph' and @hierarchy='']/RecordSet[@id='1']">
					...
					<html>
						...
						<body>
							...
							<script type="text/javascript">
								...
								<xsl:for-each select="//MSSQLResult[@name='GetStackedColumnGraph']/RecordSet/Row">
									chartData.push({
										name: '<xsl:value-of select="LineName"/>',

										values: [
											<xsl:value-of select="PointValue1"/>,
											<xsl:value-of select="PointValue2"/>,
											<xsl:value-of select="PointValue3"/>,
											<xsl:value-of select="PointValue4"/>
										]
									});
								</xsl:for-each>
