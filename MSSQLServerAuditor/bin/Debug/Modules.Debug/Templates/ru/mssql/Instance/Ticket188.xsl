...
<root>
	<mssqlauditorpreprocessors name="Диаграмма для задачи #188" id="Ticket188Diagram.Graph.ru" columns="100" rows="50;50" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="Ticket188Diagram.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
			<GraphConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
				...
				<GraphSource xsi:type="XmlFileGraphSource">
					...
					<PathToItems>/MSSQLResults/MSSQLResult[@name='Ticket188TestSql' and @hierarchy='']/RecordSet[@id='1']</PathToItems>
					<ItemTag>Row</ItemTag>
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="jTicket188Diagram.Graph.ru" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<xsl:template match="/MSSQLResults/MSSQLResult[@name='Ticket188TestSql' and @hierarchy='']/RecordSet[@id='1']">
					...
					<html>
						...
						<body>
							...
							<script type="text/javascript">
								...
								<xsl:for-each select="//MSSQLResult[@name='Ticket188TestSql']/RecordSet/Row">
									chartData.push({
										name: '<xsl:value-of select="DatabaseName"/>',

										values: [
											<xsl:value-of select="DatabaseRestoreSizeMB"/>
										]
									});
								</xsl:for-each>
