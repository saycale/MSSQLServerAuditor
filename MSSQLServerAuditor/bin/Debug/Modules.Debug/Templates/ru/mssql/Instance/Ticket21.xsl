	...
	<mssqlauditorpreprocessors name="Диаграмма для задачи #21" id="Ticket21Diagram.Graph.ru" columns="100" rows="50;50" splitter="yes">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="jTicket21Diagram.Graph.ru" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<xsl:key name="JobName" match="Row" use="JobName" />
				...
				<xsl:template match="/MSSQLResults/MSSQLResult[@name='Ticket21TestSql' and @hierarchy='']/RecordSet[@id='1']">
					...
					<html>
						...
						<body>
							...
							<script type="text/javascript">
								...
								labels = [
									<xsl:for-each select="//Row[generate-id(.) = generate-id (key('JobName', JobName))]">
								...
								<xsl:for-each select="//MSSQLResult[@name='Ticket21TestSql']/RecordSet/Row">
									chartData.push(
										{
											name: '<xsl:value-of select="JobRunDateTime"/>',
