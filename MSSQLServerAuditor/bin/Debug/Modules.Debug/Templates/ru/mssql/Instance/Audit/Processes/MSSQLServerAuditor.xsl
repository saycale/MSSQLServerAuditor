...
<root>
	<mssqlauditorpreprocessors name="Запущенные процессы (пользовательские)" id="ServerUserProcesses.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="ServerUserProcesses.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Запущенные процессы (все)" id="ServerAllProcesses.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="ServerAllProcesses.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
				<xsl:stylesheet version="1.0"
						xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
						xmlns:ms="urn:schemas-microsoft-com:xslt"
						xmlns:dt="urn:schemas-microsoft-com:datatypes">
