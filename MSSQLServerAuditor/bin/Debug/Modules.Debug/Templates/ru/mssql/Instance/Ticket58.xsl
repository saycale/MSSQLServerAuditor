...
<root>
	<mssqlauditorpreprocessors name="Диаграмма для задачи #58" id="Ticket58Diagram.Graph.ru" columns="100" rows="50;50" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="Ticket58Diagram.Graph.ru" column="1" row="1" colspan="1" rowspan="1">
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="jTicket21Diagram.Graph.ru" column="1" row="2" colspan="1" rowspan="1">
			<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<xsl:template match="/MSSQLResults/MSSQLResult[@name='Ticket58TestSql' and @hierarchy='']/RecordSet[@id='1']">
					...
					<html>
						...
						<body>
							...
							<script type="text/javascript">
								...
								<xsl:for-each select="//MSSQLResult[@name='Ticket58TestSql']/RecordSet/Row">
									chartData.push({
										name: '<xsl:value-of select="RestoreDate"/>',
