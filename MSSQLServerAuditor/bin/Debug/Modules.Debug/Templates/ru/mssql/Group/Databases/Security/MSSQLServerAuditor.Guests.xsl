...
<root>
	<mssqlauditorpreprocessors name="Гостевые учётные записи" id="Guests.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="Guests.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
				...
				<tbody>
					<xsl:for-each select="MSSQLResults/GetActiveGuests">
						<tr>
							<td>
								<xsl:choose>
									<xsl:when test="Instance != ''">
