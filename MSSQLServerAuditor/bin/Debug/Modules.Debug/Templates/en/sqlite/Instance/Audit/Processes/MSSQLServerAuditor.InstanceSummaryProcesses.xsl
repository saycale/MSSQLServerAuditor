...
<root>
	<mssqlauditorpreprocessors name="Процессы на сервере" id="InstanceSummaryProcesses.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Процессы на сервере" id="InstanceSummaryProcesses.HTML.en" column="1" row="1" colspan="1" rowspan="1">
