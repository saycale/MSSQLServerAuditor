...
<root>
	<mssqlauditorpreprocessors name="EventLogMessages" id="EventLogMessages.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="EventLogMessages" id="EventLogMessages.HTML.en" column="1" row="1" colspan="1" rowspan="1">
