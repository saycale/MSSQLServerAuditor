...
<root>
	<mssqlauditorpreprocessors name="Диаграмма для проблемы #188" id="Ticket188TestSql.Graph.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Диаграмма для проблемы #188" id="Ticket188TestSql.Graph.en" column="1" row="1" colspan="1" rowspan="1">
