...
<root>
	<mssqlauditorpreprocessors name="Данные об экземпляре MS SQL сервера" id="AuditInstanceParameters.HTML.en" columns="100" rows="90;10" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Данные об экземпляре MS SQL сервера" id="AuditInstanceParameters.HTML.en" column="1" row="1" colspan="1" rowspan="1" text-vertical-align="Top" text-align="Left">
					...
					<tr>
						...
						<td align="right">
							<xsl:if test="ProductVersion != LatestVersion">
								<xsl:attribute name="bgcolor">#F2F5A9</xsl:attribute>
							</xsl:if>
							<xsl:choose>
		...
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Результаты выполнения" id="AuditInstanceParameters.HTML.Results.en" column="1" row="2" colspan="1" rowspan="1" text-vertical-align="Top" text-align="Left">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
