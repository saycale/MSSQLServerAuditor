...
<root>
	<mssqlauditorpreprocessors name="Использование процессора" id="InstanceMemoryStatus.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="InstanceCPUUtilization.Graph.en" column="1" row="1" colspan="1" rowspan="1">
