...
<root>
	<mssqlauditorpreprocessors name="Линейный график с именованными линиями" id="NamedLineGraph.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="" id="NamedLineGraph.Graph.en" column="1" row="1" colspan="1" rowspan="1">
