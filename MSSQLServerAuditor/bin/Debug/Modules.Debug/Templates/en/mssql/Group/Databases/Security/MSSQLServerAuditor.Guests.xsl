...
<root>
	<mssqlauditorpreprocessors name="Гостевые учётные записи" id="Guests.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="Guests.HTML.en" column="1" row="1" colspan="1" rowspan="1">
