...
<root>
	<mssqlauditorpreprocessors name="Guest entries" id="Guests.HTML.en" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Guest entries" id="Guests.HTML.en">
