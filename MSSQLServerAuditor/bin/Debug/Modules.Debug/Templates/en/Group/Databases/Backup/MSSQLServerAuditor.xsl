...
<root>
	<mssqlauditorpreprocessors name="Database backup (size in MBytes)" id="GroupDatabasesBackup.HTML.en" columns="100" rows="100" splitter="yes">
	<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database backup (size in MBytes)" id="GroupDatabasesBackup.HTML.en">
