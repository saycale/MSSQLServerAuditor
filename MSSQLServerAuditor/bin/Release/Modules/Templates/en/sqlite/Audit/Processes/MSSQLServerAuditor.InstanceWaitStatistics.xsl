...
<root>
	<mssqlauditorpreprocessors name="Instance Wait Statistics" id="InstanceWaitStatistics.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Instance Wait Statistics" id="InstanceWaitStatistics.HTML.en" column="1" row="1" colspan="1" rowspan="1">
