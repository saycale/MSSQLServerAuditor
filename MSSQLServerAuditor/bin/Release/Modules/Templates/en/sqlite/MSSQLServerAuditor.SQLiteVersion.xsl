...
<root>
	<mssqlauditorpreprocessors name="About SQLite" id="SQLiteVersion.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="About SQLite" id="SQLiteVersion.HTML.en" column="1" row="1" colspan="1" rowspan="1">
