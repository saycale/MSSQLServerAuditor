...
<root>
	<mssqlauditorpreprocessors name="Instance IO Status" id="InstanceIOStatus.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Instance IO Status" id="InstanceIOStatus.HTML.en" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Disks I/O" id="InstanceDiskIOStatus.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Disks I/O" id="InstanceDiskIOStatus.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
	...
	<mssqlauditorpreprocessors name="Databases I/O" id="InstanceDatabaseIOStatus.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Databases I/O" id="InstanceDatabaseIOStatus.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			<xsl:stylesheet version="1.0"
				  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:ms="urn:schemas-microsoft-com:xslt"
				  xmlns:dt="urn:schemas-microsoft-com:datatypes">
