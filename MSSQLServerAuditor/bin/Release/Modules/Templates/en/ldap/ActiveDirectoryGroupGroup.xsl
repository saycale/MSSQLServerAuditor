...
<root>
	<mssqlauditorpreprocessors name="LDAP Group Group" id="LDAPGroupGroup.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="LDAP Group Group" id="LDAPGroupGroup.HTML.en" column="1" row="1" colspan="1" rowspan="1">
