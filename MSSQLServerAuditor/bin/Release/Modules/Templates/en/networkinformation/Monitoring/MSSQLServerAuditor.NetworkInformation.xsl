...
<root>
	<mssqlauditorpreprocessors name="Server Network Status" id="NetworkInformation.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="" id="NetworkInformation.HTML.en" column="1" row="1" colspan="1" rowspan="1">
