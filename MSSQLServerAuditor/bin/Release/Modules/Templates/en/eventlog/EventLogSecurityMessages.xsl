...
<root>
	<mssqlauditorpreprocessors name="EventLog Security Messages" id="EventLogSecurityMessages.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="EventLog Security Messages" id="EventLogSecurityMessages.HTML.en" column="1" row="1" colspan="1" rowspan="1">
