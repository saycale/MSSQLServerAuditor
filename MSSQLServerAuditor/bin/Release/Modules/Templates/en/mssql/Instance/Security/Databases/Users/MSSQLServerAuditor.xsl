...
<root>
	<mssqlauditorpreprocessors name="Database users" id="DatabaseUsers.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database users" id="DatabaseUsers.HTML.en" column="1" row="1" colspan="1" rowspan="1">
