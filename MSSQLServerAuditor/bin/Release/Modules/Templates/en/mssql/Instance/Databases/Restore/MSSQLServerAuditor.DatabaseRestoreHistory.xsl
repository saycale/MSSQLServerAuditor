...
<root>
	<mssqlauditorpreprocessors name="Restoration History (tables)" id="DatabaseRestoreHistory.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Restoration History (tables)" id="DatabaseRestoreHistory.HTML.en" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Restoration History (graphs)" id="DatabaseRestoreHistory.Graph.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Restoration History (graphs)" id="DatabaseRestoreHistory.Graph.en" column="1" row="1" colspan="1" rowspan="1">
