...
<root>
	<mssqlauditorpreprocessors name="Data and Log files on the same physical drive" id="DatabaseDataLogFilesIssue.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Data and Log files on the same physical drive" id="DatabaseDataLogFilesIssue.HTML.en" column="1" row="1" colspan="1" rowspan="1">
