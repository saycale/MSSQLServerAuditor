...
<root>
	<mssqlauditorpreprocessors name="Linked servers" id="LinkedServers.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Linked servers" id="LinkedServers.HTML.en" column="1" row="1" colspan="1" rowspan="1">
