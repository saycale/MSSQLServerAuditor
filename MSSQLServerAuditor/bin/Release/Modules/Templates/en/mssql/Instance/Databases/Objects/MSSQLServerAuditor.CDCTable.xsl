...
<root>
	<mssqlauditorpreprocessors name="Tables with CDC enabled" id="CDCTable.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Tables with CDC enabled" id="CDCTable.HTML.en" column="1" row="1" colspan="1" rowspan="1">
