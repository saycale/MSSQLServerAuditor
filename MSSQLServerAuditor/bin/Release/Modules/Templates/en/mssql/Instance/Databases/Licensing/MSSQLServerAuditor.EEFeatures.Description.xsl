...
<root>
	<mssqlauditorpreprocessors name="Enterprise Edition Features In Use" id="DatabaseEnterpriseEditionFeatures.Description.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Enterprise Edition Features In Use" id="DatabaseEnterpriseEditionFeatures.Description.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<h1 class="firstHeading">Enterprise Edition Features In Use</h1>
				...
				<p><strong>How to correct it:</strong> If you've got Standard Edition servers in
