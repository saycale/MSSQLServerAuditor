...
<root>
	<mssqlauditorpreprocessors name="Tables with float columns" id="TablesWithFloatTypes.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Tables with float columns" id="TablesWithFloatTypes.HTML.en" column="1" row="1" colspan="1" rowspan="1">
