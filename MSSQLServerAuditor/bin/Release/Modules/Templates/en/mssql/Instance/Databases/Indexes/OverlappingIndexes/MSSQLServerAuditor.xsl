...
<root>
	<mssqlauditorpreprocessors name="Overlapping Indexes" id="OverlappingIndexes.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Overlapping Indexes" id="OverlappingIndexes.HTML.en" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<thead>
					<tr>
						...
						<th>
							OverlappingIndexType
						</th>
						<th>
							OverlappingIndexKeyColumns
						</th>
					</tr>
				</thead>
				<tbody>
