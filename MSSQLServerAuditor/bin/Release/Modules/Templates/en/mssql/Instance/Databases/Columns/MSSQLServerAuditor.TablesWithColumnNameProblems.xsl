...
<root>
	<mssqlauditorpreprocessors name="Tables with problems in column names" id="TablesWithColumnNameProblems.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Tables with problems in column names" id="TablesWithColumnNameProblems.HTML.en" column="1" row="1" colspan="1" rowspan="1">
