...
<root>
	<mssqlauditorpreprocessors name="Tables with keys based on NewID" id="TablesWithUniqueIdentifierColumn.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Tables with keys based on NewID" id="TablesWithUniqueIdentifierColumn.HTML.en" column="1" row="1" colspan="1" rowspan="1">
