...
<root>
	<mssqlauditorpreprocessors name="Forwarded records" id="IndexesWithForwardedRecords.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Forwarded records" id="IndexesWithForwardedRecords.HTML.en" column="1" row="1" colspan="1" rowspan="1">
