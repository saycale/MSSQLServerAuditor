...
<root>
	<mssqlauditorpreprocessors name="Local disks on the server" id="ServerDisks.Graph.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Local disks on the server" id="ServerDisks.Graph.en" column="1" row="1" colspan="1" rowspan="1">
