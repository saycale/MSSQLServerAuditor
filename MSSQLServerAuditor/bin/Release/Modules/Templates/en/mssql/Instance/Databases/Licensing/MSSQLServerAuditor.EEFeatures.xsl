...
<root>
	<mssqlauditorpreprocessors name="Enterprise Edition Features In Use" id="DatabaseEnterpriseEditionFeatures.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Enterprise Edition Features In Use" id="DatabaseEnterpriseEditionFeatures.HTML.en" column="1" row="1" colspan="1" rowspan="1">
