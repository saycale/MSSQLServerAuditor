...
<root>
	<mssqlauditorpreprocessors name="Databases backup history (tables)" id="DatabaseBackupHistory.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Databases backup history (tables)" id="DatabaseBackupHistory.HTML.en" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Databases backup history (graphs)" id="DatabaseBackupHistory.Graph.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Databases backup history (graphs)" id="DatabaseBackupHistory.Graph.en" column="1" row="1" colspan="1" rowspan="1">
