...
<root>
	<mssqlauditorpreprocessors name="Database restoration: date and size (MBytes)" id="DatabasesRestore.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database restoration: date and size (MBytes)" id="DatabasesRestore.HTML.en" column="1" row="1" colspan="1" rowspan="1">
