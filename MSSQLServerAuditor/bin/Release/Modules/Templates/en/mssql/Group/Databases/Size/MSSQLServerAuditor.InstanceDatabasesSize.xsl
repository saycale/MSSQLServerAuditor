...
<root>
	<mssqlauditorpreprocessors name="Database Size (MB)" id="DatabasesSize.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Database Size (MB)" id="DatabasesSize.HTML.en" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Database Size (MB)" id="DatabasesSize.Table.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="DataGridPreprocessorDialog" name="Database Size (MB)" id="DatabasesSize.Table.en" column="1" row="1" colspan="1" rowspan="1">
