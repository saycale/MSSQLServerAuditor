...
<root>
	<mssqlauditorpreprocessors name="Data about MS SQL server" id="AuditInstanceParameters.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Data about MS SQL server" id="AuditInstanceParameters.HTML.en" column="1" row="1" colspan="1" rowspan="1">
