...
<root>
	<mssqlauditorpreprocessors name="Instance Databases Size (MB)" id="Monitoring.Instance.DatabasesSize.HTML.en" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Instance Databases Size (MB)" id="Monitoring.Instance.DatabasesSize.HTML.en" column="1" row="1" colspan="1" rowspan="1">
