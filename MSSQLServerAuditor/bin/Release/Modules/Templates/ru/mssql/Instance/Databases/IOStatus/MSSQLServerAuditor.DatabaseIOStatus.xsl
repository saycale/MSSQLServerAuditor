...
<root>
	<mssqlauditorpreprocessors name="Нагрузка дисковой системы" id="DatabaseIOStatus.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Нагрузка дисковой системы" id="DatabaseIOStatus.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<xsl:if test="MSSQLResult[@name='GetDatabaseIOStatus' and @SqlErrorNumber='0' and @hierarchy='']/RecordSet[@id='1']/child::node()">
				<table id="myTable">
				<thead>
					<tr>
						<th rowspan="2">
				...
				<tbody>
					<xsl:for-each select="MSSQLResult[@name='GetDatabaseIOStatus' and @SqlErrorNumber='0' and @hierarchy='']/RecordSet[@id='1']/Row">
					<tr>
						<td>
							<xsl:choose>
								<xsl:when test="../../@instance != ''">
