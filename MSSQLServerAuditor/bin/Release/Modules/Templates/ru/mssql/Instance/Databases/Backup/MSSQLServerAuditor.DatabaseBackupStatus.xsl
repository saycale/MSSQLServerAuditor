...
<root>
	<mssqlauditorpreprocessors name="Архивные копии баз данных (размер МБайт)" id="DatabasesBackupStatus.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Архивные копии баз данных (размер МБайт)" id="DatabasesBackupStatus.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
	...
	<mssqlauditorpreprocessors name="Диаграмма размеров архивных копий" id="DatabasesBackupStatus.ColumnDiagramm.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="GraphPreprocessorDialog" name="Диаграмма размеров архивных копий" id="DatabasesBackupStatus.ColumnDiagramm.ru" column="1" row="1" colspan="1" rowspan="1">
