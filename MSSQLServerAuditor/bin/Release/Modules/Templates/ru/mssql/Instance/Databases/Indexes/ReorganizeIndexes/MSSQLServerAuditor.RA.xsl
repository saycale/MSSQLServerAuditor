...
<root>
	<mssqlauditorpreprocessors name="Индексы для выполнения операции Reorganize" id="ReorganizeIndexes.Description.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Индексы для выполнения операции Reorganize" id="ReorganizeIndexes.Description.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<h1 class="firstHeading">Индексы, для которых нужно провести операцию "Reorganize"</h1>

				<p>В отчёте представлены индексы, для которых рекомендуется провести операцию "Reorganize".</p>

				<p><strong>Уровень сложности:</strong> Легкий</p>

				<p><strong>Уровень опасности:</strong> Средний</p>

				<p><a href="http://technet.microsoft.com/en-us/library/ms189858.aspx" target="_blank">Организуйте и постройте индексы заново</a></p>
