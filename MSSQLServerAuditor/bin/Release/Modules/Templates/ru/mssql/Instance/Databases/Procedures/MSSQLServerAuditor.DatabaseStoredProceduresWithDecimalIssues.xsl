...
<root>
	<mssqlauditorpreprocessors name="Хранимые процедуры без указания переменных с плавающей запятой" id="DatabaseProceduresWithDecimalIssues.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Хранимые процедуры без указания переменных с плавающей запятой" id="DatabaseProceduresWithDecimalIssues.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
