...
<root>
	<mssqlauditorpreprocessors name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Активные работающие процессы (статистика за 15 секунд)" id="UpMonitor.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
