...
<root>
	<mssqlauditorpreprocessors name="Текущие соединения с сервером" id="InstanceConnections.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Текущие соединения с сервером" id="InstanceConnections.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
