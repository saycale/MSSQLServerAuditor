...
<root>
	<mssqlauditorpreprocessors name="Нагрузка дисковой системы" id="InstanceIOStatus.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Нагрузка дисковой системы" id="InstanceIOStatus.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
