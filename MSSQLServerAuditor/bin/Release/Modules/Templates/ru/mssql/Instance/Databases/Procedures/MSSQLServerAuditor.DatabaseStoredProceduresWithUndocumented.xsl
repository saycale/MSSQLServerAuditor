...
<root>
	<mssqlauditorpreprocessors name="Хранимые процедуры с вызовом недокументированных функций" id="DatabaseProceduresWithUndocumented.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Хранимые процедуры с вызовом недокументированных функций" id="DatabaseProceduresWithUndocumented.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
