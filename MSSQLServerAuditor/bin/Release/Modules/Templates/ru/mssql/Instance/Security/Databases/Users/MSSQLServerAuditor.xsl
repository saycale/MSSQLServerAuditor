...
<root>
	<mssqlauditorpreprocessors name="Пользователи базы данных" id="DatabaseUsers.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Пользователи базы данных" id="DatabaseUsers.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
