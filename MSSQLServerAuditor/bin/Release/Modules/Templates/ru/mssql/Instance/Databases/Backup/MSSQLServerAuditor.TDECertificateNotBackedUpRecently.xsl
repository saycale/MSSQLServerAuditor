...
<root>
	<mssqlauditorpreprocessors name="Архивные копии для сертификатов" id="TDECertificateNotBackedUpRecently.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Архивные копии для сертификатов" id="TDECertificateNotBackedUpRecently.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
			...
			<body>
				...
				<thead>
					<tr>
						...
						<th>
							Дата последнего архивного копирования
						</th>
						<th>
							Статус
						</th>
