...
<root>
	<mssqlauditorpreprocessors name="Таблицы без первичного ключа" id="TablesWithoutAPrimaryKey.HTML.ru" columns="100" rows="100" splitter="yes">
		<mssqlauditorpreprocessor preprocessor="HtmlPreprocessorDialog" name="Таблицы без первичного ключа" id="TablesWithoutAPrimaryKey.HTML.ru" column="1" row="1" colspan="1" rowspan="1">
