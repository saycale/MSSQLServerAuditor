...
namespace MSSQLServerAuditor.Utils
{
	public static class ControlExtensions
	{
		...
		public static void SafeInvoke<T>(this T control, Action<T> action) where T : Control
		{
		...
		/// <param name="control"></param>
		/// <param name="action"></param>
		public static IAsyncResult SafeBeginInvoke<T>(this T control, Action<T> action) where T : Control
		{
		...
		/// <param name="control"></param>
		/// <param name="action"></param>
		public static object SafeEndInvoke<T>(this T control, IAsyncResult result) where T : Control
		{
			return control.EndInvoke(result);
		}

		public static void DisposeChildControls(this TabPage page)
		{
			if (page != null)
			{
